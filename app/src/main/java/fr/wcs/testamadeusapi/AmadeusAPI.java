...
/**
 * Created by apprenti on 1/31/18.
 */
...
public class AmadeusAPI {
    ...
    public static void getTravels(Context context, final AmadeusAPIResponse listener) {
        ...
        String params = "?apikey=Gi4UQGRveh74nowTrXDtrBSWrWK85Eks&origin=NYC&destination=LAS&departure_date=2018-01-31--2018-01-31";
        url += params;
